...
| name | description |
| --- | --- |
| `argue-to-cook` | msc thesis on multi-agent reinforcement learning. investigates whether a value based argumentation framework with state adaptive rules improves PPO coordination between two agents in the overcooked-ai cooperative environment |
